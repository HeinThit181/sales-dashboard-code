...
<h3>Scope</h3>
<p>This project is a client-side Sales Tracking and Analytics System built using React. It allows users to record sales transactions, store them locally in the browser, and visualize sales performance through an interactive dashboard with charts, statistics, and tables.

The system is designed for small businesses or educational use, requiring no backend server or database, relying entirely on localStorage for data persistence.</p>
<hr/>
...
<ol>
  <li>
    <h4>Member 1</h4>
    <ul>
      <li>Name - Hein Thit Swan</li>
      <li>ID - 6715181</li>
      <li>Git Hub Name - HeinThit181</li>
    </ul>
  </li>
  <li>
    <h4>Member 2</h4>
    <ul>
      <li>Name - Swan Yee Htet</li>
      <li>ID - 6715082</li>
      <li>Git Hub Name - SwanYee1iel</li>
    </ul>
  </li>
  <li>
    <h4>Member 3</h4>
...
![Dashboard Preview](images/Dashboard_d.png)
...
![Dashboard Preview](images/sales.png)
<hr/>
